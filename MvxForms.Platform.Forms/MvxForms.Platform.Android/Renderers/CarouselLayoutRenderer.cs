...
namespace MvxForms.Android.Renderers
{
	public class CarouselLayoutRenderer : ScrollViewRenderer
	{
		...
		void UpdateSelectedIndex()
		{
			...
			System.Diagnostics.Debug.WriteLine($"UpdateSelectedIndex-_scrollView.ScrollX:{_scrollView.ScrollX}");
		...
		void SnapScroll()
		{
			...
			System.Diagnostics.Debug.WriteLine($"SnapScroll-_scrollView.ScrollX:{_scrollView.ScrollX}");
			var targetIndex =
